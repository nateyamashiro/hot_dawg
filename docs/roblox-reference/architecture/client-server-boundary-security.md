...
url: /docs/en-us/scripting/security/client-server-boundary
...
![Example purchase flow from client to server through a RemoteEvent](../../assets/scripting/security/Remote-Purchase-Flow.png)_Example purchase flow from client to server through a `Class.RemoteFunction`_
