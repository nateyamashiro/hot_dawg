...
url: /docs/en-us/luau/control-structures
...
> **Error:** Always include a delay such as `Library.task.wait()` in an infinite loop. Omitting it freezes the experience and crashes Studio.
## Repeat loops
